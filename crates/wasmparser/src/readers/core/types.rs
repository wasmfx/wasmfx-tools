...
impl Matches for HeapType {
        ...
        F: Fn(u32) -> &'a SubType,
    {
        ...
        match (self, other) {
            ...
            (HT::Concrete(a), HT::Cont) => {
                matches!(type_at(*a).composite_type, CompositeType::Cont(_))
            }

            (HT::NoCont, HT::Concrete(b)) => {
                matches!(type_at(*b).composite_type, CompositeType::Cont(_))
            }
...
impl Matches for CompositeType {
        ...
        F: Fn(u32) -> &'a SubType,
    {
        match (self, other) {
            ...
            (CompositeType::Cont(a), CompositeType::Cont(b)) => a.matches(b, type_at),
            _ => false,
        }
    }
}
...
impl Matches for ContType {
        ...
        F: Fn(u32) -> &'a SubType,
    {
        ...
        let y = type_at(other.0); // returns a SubType
                                  ...
                                  // interpreter.
        x.composite_type.matches(&y.composite_type, type_at)
    }
}
