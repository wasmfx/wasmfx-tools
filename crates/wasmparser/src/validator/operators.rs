...
use crate::{
    ...
    BrTable, Catch, CompositeType, ContType, FieldType, FuncType, GlobalType, HeapType, Ieee32,
    Ieee64, MemArg, RefType, Result, ResumeTable, StorageType, StructType, SubType, TableType,
